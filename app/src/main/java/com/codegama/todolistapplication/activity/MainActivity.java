...
public class MainActivity extends BaseActivity implements CreateTaskBottomSheetFragment.setRefreshListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alertDialog.setTitle("Thay đổi tên người dùng");
        alertDialog.setView(Editname);
        alertDialog.setButton(DialogInterface.BUTTON_POSITIVE, "Lưu tên", new DialogInterface.OnClickListener() {
            @Override
        ...
        taskRecycler.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
